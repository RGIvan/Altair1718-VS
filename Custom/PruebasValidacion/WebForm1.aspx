...
<head runat="server">
    ...
    <script type="text/javascript">
        function ValidaEdad(source, arguments) {
            txbSeguimiento.value += "\nEstoy en la validación del cliente";
            ...
            if (valor < 18 || valor > 75) {//Se realiza la comparación del valor esperado
                arguments.IsValid = false;
                return;
            }
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:TextBox ID="txbSeguimiento" runat="server" Rows="4" TextMode="MultiLine" Width="555px" BackColor="#FFFFCC" Font-Bold="True" Height="114px">Proceso de la página a partir del CustomValidator de &quot;Repite Edad&quot;</asp:TextBox>
            <br />
            <table>
                <tr>
                    <td>&nbsp;Edad 
                ...
                <tr>
                    ...
                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txbEdad" ControlToValidate="txbRepEdad" ErrorMessage="Los campos Edad y Repite Edad deben ser iguales" ForeColor="Red" Display="Dynamic">Debe repetir la edad</asp:CompareValidator>
                        <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="txbRepEdad" ErrorMessage="CustomValidator" ClientValidationFunction="ValidaEdad" Font-Bold="True" Display="Dynamic" OnServerValidate="CustomValidator1_ServerValidate" ForeColor="Red">CUSTOM DETECTÓ ERROR</asp:CustomValidator>
