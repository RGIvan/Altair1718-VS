    ...
    <div>
        ...
        <asp:Panel ID="panelControles" runat="server" Width="100%" Height="75" BackColor="#FF8000">
            ...
            <table style="width:100%;">
                ...
                <asp:Panel ID="panelConfirmaBorrado" runat="server" Width="100%" Height="75" BackColor="Red" Visible="False">
            <br />
            <table style="width:100%;">
                <tr>
                    <td class="columna_izquierda">&nbsp;
                    ...
                    <td class="columna_central">
                        <asp:Label ID="lbConfirmacion" runat="server" Font-Bold="True" Font-Size="Larger" Text="Label"></asp:Label>
                        <br />
                        <asp:Button ID="btnBorrar" runat="server" Font-Bold="True" text="Si" OnClick="btnBorrar_Click"/>
                        &nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnNoBorrar" runat="server" Font-Bold="True" text="No" OnClick="btnNoBorrar_Click" />
                    </td>
                    <td class="columna_derecha">&nbsp;&nbsp;
                        </td>
                </tr>
