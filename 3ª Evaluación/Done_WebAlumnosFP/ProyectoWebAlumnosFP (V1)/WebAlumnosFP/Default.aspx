            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td class="columna_central">
                        ...
                        <asp:Label ID="lbConfirmacion" runat="server" Font-Bold="True" Font-Size="Larger" Text="Label" Visible="False"></asp:Label>
                        <br />
                        <asp:Button ID="btnBorrar" runat="server" Font-Bold="True" text="Si" Visible="False" OnClick="btnBorrar_Click"/>
                        &nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnNoBorrar" runat="server" Font-Bold="True" text="No" Visible="False" OnClick="btnNoBorrar_Click" />
                    </td>
