...
namespace WebAlumnosFP
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        void MostrarConfirmacionBorrado(bool loMostramos)
        {
            if (loMostramos)
            {
            ...
            dgv.Enabled = !loMostramos;        // <-- Des/Habilitamos el GridView
            panelControles.Visible = !loMostramos;
            panelConfirmaBorrado.Visible = loMostramos;
        }
