...
namespace InterfazUsuario
{
    public partial class IUAlumnos : Form
    {
        ...
        private void EditarRegistro(int fila)
        {
            ...
            // Construyo el formulario detalle que voy a usar pasándole el alumno
            IUDetalleAlumno fDetalle = new IUDetalleAlumno(listaGrupos, alum);
        ...
        private void btnAnadir_Click(object sender, EventArgs e)
        {
            ...
            // Construyo el formulario detalle que voy a usar sin pasarle nada
            IUDetalleAlumno fDetalle = new IUDetalleAlumno(listaGrupos);
            //... y muestro el formulario para poder modificar
